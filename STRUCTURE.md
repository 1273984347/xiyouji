...
> 当前版本：v2.3.138（2026-09-05）— W539 遗留收尾（vite 5→6.4.3 清零 devDep 漏洞 + dompurify 3.4.14 根治 Dependabot 冲突） — A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
