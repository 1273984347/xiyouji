...
> 当前版本：v2.3.137（2026-09-05）— W538 CI 红灯热修复（batch_screenshots 白名单形状回归 + agent-web 依赖 overrides） — A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
