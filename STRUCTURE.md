...
> 当前版本：v2.3.124（2026-08-26）— W525 漂移审查修复（drift-audit 全仓体检：file-index W504 段缺失补建 + W522-W524 尾部追加重排归位·workflows README 同步至 W524·文档规范 §8 门禁表对齐）·A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
