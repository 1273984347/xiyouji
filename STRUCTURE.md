...
> 当前版本：v2.3.100（2026-08-24）— W501 元信息块 v2（第 18 门禁 check_frontmatter.py 挂载：新文件血缘+核验状态 4 字段必填·基线豁免存量 611 篇）·A1-A6 共 611 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
