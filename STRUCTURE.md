...
> 当前版本：v2.3.78（2026-08-17）— W463 墨韵 W-g 收尾固化 + W-f 扫尾批（DESIGN.md §5 动效宪法 + loading/fade-in·墨韵系列收官）·A1-A6 共 611 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
