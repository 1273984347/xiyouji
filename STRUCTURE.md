...
> 当前版本：v2.3.113（2026-08-25）— W513 归档二级归档（方案 A：CHANGELOG-ARCHIVE W001-W399 下移 tier2·917→150KB）·A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。 + W514（治理文档口径修复）
