...
> 当前版本：v2.3.95（2026-08-22）— W496 优化收尾（夜读切换钮全站+test_smoke 样式断言+acceptance_snapshot 现测铁律+fps 遗留关闭）·A1-A6 共 611 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
