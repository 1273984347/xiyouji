...
> 当前版本：v2.3.96（2026-08-24）— W497 skills 治理同步（仓库版 visual-batch v1.2.0/plan-authoring v1.1.0 对齐·day-review 收录入库·收尾三同步固化）·A1-A6 共 611 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
