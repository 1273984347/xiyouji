...
> 当前版本：v2.3.125（2026-08-26）— W526 索引健康门禁盲区封堵（check_index_health 新增段倒序断言 + 段缺失检测·verify_delivery 新增第 23 门禁旁文档同步——W525 实证三项漏网全堵）·A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
