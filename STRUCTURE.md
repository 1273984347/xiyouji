...
> 当前版本：v2.3.130（2026-08-29）— W531 skills 部署全查 + 三真源降级保护（sync_skills 方向判定+降级拦截+--take-global 回写·四通用技能回写真源版）·A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。 + W531（W531 skills 部署全查 + 三真源降级保护）
