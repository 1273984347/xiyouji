...
> 当前版本：v2.3.135（2026-09-02）— W536 依赖积压治理（6 个 dependabot PR 清零 + ESLint flat config 迁移 + agent-web 主版本分层） — A1-A6 共 615 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
