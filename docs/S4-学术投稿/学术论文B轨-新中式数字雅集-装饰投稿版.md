...
> 本稿为《装饰》投稿版 v2.3。**字数为当批实测**（2026-09-22·去 Markdown 记号后非空白字符）：中文摘要 220 字；正文 1-8 节 6,425 字；全稿含中英文摘要、注释与参考文献 10,577 字符（英文摘要按字母计；若英文按词计则约 9,930）——处于官网 8000-10000 字（含注释参考文献）区间。配套图表 9 张见 [图表目录](图表_清单.md)（图 1/2/6 重绘与风格统一见 scripts/_w606_paper_figures.py）。完整论证见 [完整稿](学术论文B轨-新中式数字雅集.md)。
