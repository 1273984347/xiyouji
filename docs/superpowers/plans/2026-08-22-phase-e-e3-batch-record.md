# Phase E3（W490）CN 可视化页传播 II · 批次记录

> 主方案：[2026-08-18-phase-e-visual-elevation-roadmap.md](2026-08-18-phase-e-visual-elevation-roadmap.md) §3 E3
> 范围：86 页减 E2 批 56 页 = **30 页**（3D/Canvas、时间线/地图、静态/表格、检索等非网络热力页；`git diff 68168a6` 派生）
> 规则：复用 _w478_migrate.py 六规则（R-SHADOW / R-RADIUS / R-TRANS / R-FOCUS / 裸色白名单 / R-EXEMPT）；3D 页（character-relationship-3d/journey-geo-3d）深度令牌仅用于 UI 层，不动场景材质
...
| journey-geo-3d.html | 0 | 4 | 0 | 0 | 0 | 3 |
| journey-route.html | 0 | 7 | 0 | 0 | 0 | 1 |
| karma-reincarnation.html | 0 | 11 | 0 | 0 | 0 | 7 |
| language-style-radar.html | 0 | 1 | 0 | 0 | 0 | 1 |
