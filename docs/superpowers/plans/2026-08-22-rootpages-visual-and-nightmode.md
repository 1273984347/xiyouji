...
| 批次 | 状态 | commit | 关键数字 |
|:---|:---|:---|:---|
| W488 本批 | ✅ 完成 | 待提交（v2.3.87） | M-A1 差异率 6/6 ≥1%（2.35/5.05/2.84/5.88/25.98/7.07%）+ 目视清单 6×3 处；dark 冒烟 6 页 pageerror=0 + FOUC=0；禁 JS 回退正常；html 增量 +3.2~6.6KB/页；tokens 7750B 未增、system +644B；五道门禁全绿 |
