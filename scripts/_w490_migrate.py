#!/usr/bin/env python3
"""W490 E3 余 30 页迁移（一次性脚本，不入门禁/CI）

复用 W478 六规则范式（R-SHADOW/R-RADIUS/R-TRANS/R-FOCUS/裸色白名单/R-EXEMPT）。
E3 派生 = 86 页减 E2 批 56 页（3D/Canvas、时间线/地图、静态/表格、检索等非网络热力页）。
...
E3_PAGES = [  # 86 减 E2 批 56 页余量（git diff 68168a6 派生，2026-08-22 实测）
    "81-hardships", "81-hardships-view", "ai-dialogue", "century-dialogue",
    "character-relationship-3d", "character-relationship-3d-view", "character-sentiment-arc",
    "chart-design", "concept-device", "criticism-history", "customs-pass-route",
    "data-explorer", "deconstruction", "ethics-consumption", "famous-time-travel",
    "game-webnovel", "global-pattern", "graph-explorer", "journey-geo-3d",
    "journey-route", "karma-reincarnation", "language-style-radar", "methodology-matrix",
    "music-structure", "narrative-experiment", "social-media", "text-search",
    "timeline", "visual-art", "workplace",
]


def derive_list():
    return [DATA / (p + ".html") for p in E3_PAGES]
