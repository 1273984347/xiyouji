...
> 2026-08-19 治理：AGENTS.md §4.5 已同步为 17 个（W484 修复 14 个 + W485 收录 visual-batch / plan-authoring / plan-review）；5 个角色 skill 的 `agents/openai.yaml` 已修复；三个 TRAE 蒸馏 skill 已做平台适配（路径占位符 + 工具映射，见各 SKILL.md 文首「平台适配」）。
