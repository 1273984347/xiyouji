...
| # | File | Lines | Purpose |
|---|---|---|---|
| 1 | `index.html` | ~450 | English landing page. Title "Journey to the West · Annotated", subtitle "A hybrid reading project". Forty-one entry cards (dashboard / academic papers / 4 data pages / 27 essays / 5 deep-dives / 2 guides / visualization tour / site map). |
...
| 17 | `site-map.html` | ~230 | Navigation capstone for the English edition: all 41 English pages indexed into seven clusters (Start Here / Data / Culture essays / Poetry essays / Contemporary essays / Characters / Visualizations), with a "how to use" note and links to the Chinese site. |
...
- Footer double-index links (`../../CHANGELOG.md` v2.3.5 W354 / `../../scripts/output/file-index.md` W354) appear on every English HTML page, matching the footer convention used across the main site.
...
2. The footer double-index: `CHANGELOG.md v2.3.5 W354` and `file-index.md W354`.
3. A Chinese↔English switch link pointing back to `../index.html` or the corresponding main-site page.

## Scope boundaries

This subproject creates the 43 files listed above under `site/en/`. It does **not**:
