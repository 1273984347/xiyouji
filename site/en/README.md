...
| # | File | Lines | Purpose |
|---|---|---|---|
| 1 | `index.html` | ~470 | English landing page. Title "Journey to the West · Annotated", subtitle "A hybrid reading project". Forty-four entry cards (dashboard / academic papers / 4 data pages / 30 essays / 5 deep-dives / 2 guides / visualization tour / site map). |
...
| 17 | `site-map.html` | ~230 | Navigation capstone for the English edition: all 44 English pages indexed into seven clusters (Start Here / Data / Culture essays / Poetry essays / Contemporary essays / Characters / Visualizations), with a "how to use" note and links to the Chinese site. |
...
- Footer double-index links (`../../CHANGELOG.md` v2.3.6 W355 / `../../scripts/output/file-index.md` W355) appear on every English HTML page, matching the footer convention used across the main site.
...
2. The footer double-index: `CHANGELOG.md v2.3.6 W355` and `file-index.md W355`.
3. A Chinese↔English switch link pointing back to `../index.html` or the corresponding main-site page.

## Scope boundaries

This subproject creates the 46 files listed above under `site/en/`. It does **not**:
