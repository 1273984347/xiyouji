...
| # | File | Lines | Purpose |
|---|---|---|---|
| 1 | `index.html` | ~440 | English landing page. Title "Journey to the West · Annotated", subtitle "A hybrid reading project". Thirty-seven entry cards (dashboard / academic papers / 4 data pages / 23 essays / 5 deep-dives / 2 guides / visualization tour / site map). |
...
| 17 | `site-map.html` | ~230 | Navigation capstone for the English edition: all 37 English pages indexed into seven clusters (Start Here / Data / Culture essays / Poetry essays / Contemporary essays / Characters / Visualizations), with a "how to use" note and links to the Chinese site. |
...
- Footer double-index links (`../../CHANGELOG.md` v2.3.4 W353 / `../../scripts/output/file-index.md` W353) appear on every English HTML page, matching the footer convention used across the main site.
...
2. The footer double-index: `CHANGELOG.md v2.3.4 W353` and `file-index.md W353`.
3. A Chinese↔English switch link pointing back to `../index.html` or the corresponding main-site page.

## Scope boundaries

This subproject creates the 39 files listed above under `site/en/`. It does **not**:
