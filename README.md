...
>
> **当前版本 v2.3.67（2026-08-16）**： W452 学术研究显式引用补齐（105 篇头部 > 引用 + verify 门禁）·W448 外部锐评回应治理（STRUCTURE 归档 + 版本号语义说明 + AI 生成披露）·A1-A6 共 611 篇 + 86 可视化页（A4 209 篇 已含）·详细变更见 [CHANGELOG.md](CHANGELOG.md)。
>
...
- **正向索引（时间线）**：[CHANGELOG.md](CHANGELOG.md) — 按版本记录变更，每版本段标注唯一 W### ID（W001-W452）+ 四件套（来源/文件/验证/状态）。v0.1-v2.0.60 历史归档至 [CHANGELOG-ARCHIVE.md](CHANGELOG-ARCHIVE.md)
