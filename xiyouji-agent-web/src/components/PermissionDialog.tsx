      ...
      <div className="space-y-4">
        ...
        >
          {request.toolName === 'Bash' && request.input.command ? (
            ...
            <Descriptions 
              column={1} 
              {...{ itemStyle: { paddingBottom: '8px' }, labelStyle: { width: '80px', color: 'var(--td-text-color-secondary)' }, contentStyle: { fontFamily: 'monospace', fontSize: '13px', wordBreak: 'break-all' } } as any}
            >
